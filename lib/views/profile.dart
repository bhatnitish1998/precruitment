...
class _ProfileState extends State<Profile> {
  ...
  profileComplete() async {
    ...
    Map<String, dynamic> userMapInfo = {
      'personalMail': _userEmailController.text,
    ...
    HelperFunctions.getUserNameSharedPreference().then((value) async {
      QuerySnapshot snap = await databaseMethods.getUserByUsername(value);
      databaseMethods.updateUser(snap.docs[0].id, userMapInfo);
    });
